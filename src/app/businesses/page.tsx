  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass-panel rounded-2xl overflow-hidden flex flex-col w-full">
        <div className="p-4 md:p-6 border-b border-zinc-800/50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-zinc-900/50">
          <div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-800/50 bg-zinc-900/80">
                <th className="py-3 px-4 md:py-4 md:px-6 text-sm font-medium text-zinc-400 whitespace-nowrap">#</th>
                <th className="py-3 px-4 md:py-4 md:px-6 text-sm font-medium text-zinc-400 whitespace-nowrap">Business Location / Address</th>
                <th className="py-3 px-4 md:py-4 md:px-6 text-sm font-medium text-zinc-400 text-right whitespace-nowrap">Unique Customers</th>
                <th className="py-3 px-4 md:py-4 md:px-6 text-sm font-medium text-zinc-400 text-right whitespace-nowrap">Total Journeys</th>
                <th className="py-3 px-4 md:py-4 md:px-6 text-sm font-medium text-zinc-400 text-right whitespace-nowrap">Total Revenue</th>
                <th className="py-3 px-4 md:py-4 md:px-6 text-sm font-medium text-zinc-400 text-center whitespace-nowrap">Status</th>
              </tr>
            </thead>
                ...
                businesses.map((b, idx) => {
                  ...
                  return (
                    <tr key={idx} className="hover:bg-zinc-800/30 transition-colors group">
                      <td className="py-3 px-4 md:py-4 md:px-6 font-medium text-zinc-500 whitespace-nowrap">{idx + 1}</td>
                      <td className="py-3 px-4 md:py-4 md:px-6 whitespace-nowrap">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <span className="text-zinc-200 font-medium block leading-tight max-w-[250px] truncate" title={b.address}>{b.address}</span>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="py-3 px-4 md:py-4 md:px-6 text-right font-medium text-emerald-400 whitespace-nowrap">
                        {formatCurrency(revenue)}
                      </td>
                      <td className="py-3 px-4 md:py-4 md:px-6 text-center whitespace-nowrap">
                        {isPotentialAccount ? (
